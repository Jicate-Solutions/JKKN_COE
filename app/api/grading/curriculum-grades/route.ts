...
// GET - Fetch all curriculum grades
export async function GET(request: Request) {
	try {
		...
		if (error) {
			console.error('Curriculum grades table error:', error)
			return NextResponse.json({ error: 'Failed to fetch curriculum grades' }, { status: 500 })
		}

		return NextResponse.json(data || [])
	} catch (e) {
		console.error('Curriculum grades API error:', e)
		return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
	}
}

// POST - Create a new curriculum grade
export async function POST(request: Request) {
	try {
		...
		if (error) {
			console.error('Error creating curriculum grade:', error)
			...
			return NextResponse.json({ error: 'Failed to create curriculum grade' }, { status: 500 })
		}

		return NextResponse.json(data, { status: 201 })
	} catch (e) {
		console.error('Curriculum grade creation error:', e)
		return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
	}
}

// PUT - Update an existing curriculum grade
export async function PUT(request: Request) {
	try {
		...
		if (error) {
			console.error('Error updating curriculum grade:', error)
			...
			return NextResponse.json({ error: 'Failed to update curriculum grade' }, { status: 500 })
		}

		return NextResponse.json(data)
	} catch (e) {
		console.error('Curriculum grade update error:', e)
		return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
	}
}

// DELETE - Delete a curriculum grade
export async function DELETE(request: Request) {
	try {
		...
		return handleDeleteWithDependencyCheck('cgpa_grades', id, request)
	} catch (e) {
		console.error('Curriculum grade deletion error:', e)
		return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
	}
}
