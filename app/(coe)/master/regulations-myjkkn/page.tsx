...
export default function RegulationsMyJKKNPage() {
	...
	const isShowAll = itemsPerPage >= filteredRegulations.length
	const effectivePerPage = isShowAll ? filteredRegulations.length || 1 : itemsPerPage

	// Calculate pagination
	const totalPages = Math.ceil(filteredRegulations.length / effectivePerPage)
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 flex-shrink-0">
						...
						<Card className="border-l-4 border-l-emerald-500 hover:shadow-md transition-shadow">
							<CardContent className="p-4">
								<div className="flex items-center justify-between">
									<div>
										<p className="text-2xl font-bold tracking-tight">{regulations.filter(r => r.is_active).length}</p>
						...
						<Card className="border-l-4 border-l-purple-500 hover:shadow-md transition-shadow">
							<CardContent className="p-4">
								<div className="flex items-center justify-between">
									<div>
										<p className="text-2xl font-bold tracking-tight">{uniqueYears.length}</p>
										<p className="text-xs font-medium text-muted-foreground mt-0.5">Unique Years</p>
									</div>
								...
								<div className="flex items-center justify-between mb-2">
									<div className="flex items-center gap-2">
										...
										<div>
											...
											<p className="text-xs text-muted-foreground">Browse and filter regulation records from MyJKKN</p>
										</div>
									</div>
								</div>
										...
										<Table>
											<TableHeader className="sticky top-0 z-10 bg-slate-50 dark:bg-slate-900/50">
												<TableRow>
													...
													<TableHead className="text-xs">Regulation Name</TableHead>
													...
													<TableHead className="w-[120px] text-xs">Institution</TableHead>
													<TableHead className="w-[100px] text-xs">
														<Button
															variant="ghost"
															size="sm"
												...
												{isLoading ? (
													<TableRow>
														<TableCell colSpan={6} className="h-32 text-center">
															<div className="flex flex-col items-center gap-2 text-muted-foreground">
																...
																<span className="text-sm">Loading regulations from MyJKKN...</span>
															</div>
														</TableCell>
													</TableRow>
													...
													paginatedRegulations.map((regulation) => (
														<TableRow key={regulation.id}>
															...
															<TableCell>
																<Badge variant={regulation.is_active ? "default" : "secondary"} className="text-xs">
													...
													<TableRow>
														<TableCell colSpan={6} className="h-32 text-center">
															<div className="flex flex-col items-center gap-2 text-muted-foreground">
																<LibraryBig className="h-8 w-8 opacity-30" />
