...
import { Building2, ArrowLeft, Loader2, Truck, UserCog, DollarSign, GraduationCap, Briefcase, Shield } from "lucide-react"

import type { Institution, DepartmentInfo, InstitutionFormData } from "@/types/institutions"
...
export default function EditInstitutionPage() {
    ...
    const fetchInstitution = async () => {
      try {
        ...
        setFormData({
          ...
          timetable_type: institution.timetable_type || "week_order",
          transportation_dept: institution.transportation_dept || {} as DepartmentInfo,
          administration_dept: institution.administration_dept || {} as DepartmentInfo,
          accounts_dept: institution.accounts_dept || {} as DepartmentInfo,
          admission_dept: institution.admission_dept || {} as DepartmentInfo,
          placement_dept: institution.placement_dept || {} as DepartmentInfo,
          anti_ragging_dept: institution.anti_ragging_dept || {} as DepartmentInfo,
  ...
  const handleSave = async () => {
    ...
    try {
      setLoading(true)
      const updatedInstitution = await updateInstitution(params.id as string, formData as InstitutionFormData)
      ...
      const errorMessage = error instanceof Error ? error.message : 'Failed to update institution. Please try again.'
      toast({
        title: "❌ Update Failed",
