...
export default function GradeSystemPage() {
  ...
  const [deleteTarget, setDeleteTarget] = useState<GradeSystem | null>(null)
  ...
  const save = async () => {
    ...
    try {
      ...
      const selectedGrade = allGrades.find(g => g.id === formData.grade_id)
              ...
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Manage grading systems</p>
                  </div>
                </div>
              </div>
                  ...
                  <Table>
                    <TableHeader className="sticky top-0 z-10 bg-slate-50 dark:bg-slate-900/50">
                      <TableRow>
                        ...
                        <TableHead className="w-[80px] text-xs">Min Mark</TableHead>
                        <TableHead className="w-[80px] text-xs">Max Mark</TableHead>
                      ...
                      {loading ? (
                        ...
                        pageItems.map((row) => (
                          <TableRow key={row.id}>
                            ...
                            <TableCell className="text-sm">{row.min_mark}</TableCell>
                            <TableCell className="text-sm">{row.max_mark}</TableCell>
                        ...
                        <TableRow>
                          <TableCell colSpan={colSpan} className="h-24 text-center text-sm text-muted-foreground">
                            {searchTerm || statusFilter !== 'all' ? 'No matching grade systems' : 'No grade systems yet'}
                          </TableCell>
                        </TableRow>
                      )}
                    </TableBody>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {(mustSelectInstitution || !shouldFilter || !institutionCode) ? (
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(code) => {
                        setFormData(prev => ({ ...prev, institutions_code: code, regulation_id: '', grade_id: '' }))
                      }}
                    >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(id) => setFormData(prev => ({ ...prev, regulation_id: id, grade_id: '' }))}
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(id) => setFormData(prev => ({ ...prev, grade_id: id }))}
                    disabled={!formData.regulation_id}
                  >
                    <SelectTrigger className={`h-10 ${errors.grade_id ? 'border-destructive' : ''} ${!formData.regulation_id ? 'bg-muted' : ''}`}>
                      <SelectValue placeholder={
                ...
                <div className="space-y-2">
                  <Label htmlFor="min_mark" className="text-sm font-medium">
                ...
                <div className="space-y-2">
                  <Label htmlFor="max_mark" className="text-sm font-medium">
