...
export type ReportCategory = 'registration' | 'exam-date'
...
interface ExamRegistrationReportsViewProps {
...
export function ExamRegistrationReportsView({
	category,
	pageTitle,
	pageDescription,
	breadcrumbLabel,
	headerIcon: HeaderIcon = ClipboardCheck,
	headerGradient = 'from-emerald-500 to-teal-600',
}: ExamRegistrationReportsViewProps) {
	...
	// Reset report type when category prop changes (defensive — should not happen normally)
	useEffect(() => {
		setSelectedReportType('')
		setReportData([])
		setReportMeta(null)
	...
	const reportOptionsForCategory = REPORT_OPTIONS.filter(o => o.group === category)
				...
				<div className="flex flex-1 flex-col gap-4 p-4 pt-0 overflow-y-auto">
					...
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-3">
							<div className={cn('h-10 w-10 rounded-lg bg-gradient-to-r flex items-center justify-center', headerGradient)}>
					...
					{/* Filters + Report Selection */}
					<Card>
						<CardContent className="pt-5 space-y-4">
							<div className={cn(
								"grid gap-3",
								mustSelectInstitution ? "grid-cols-1 md:grid-cols-2 lg:grid-cols-3" : "grid-cols-1 md:grid-cols-2"
							)}>
								{/* Institution */}
								{mustSelectInstitution && (
							...
							<div className="space-y-2">
								...
								<div className="flex flex-wrap gap-2">
									{reportOptionsForCategory.map((opt) => {
							...
							<CardContent className="py-16">
								<div className="flex flex-col items-center justify-center text-center">
									<div className="h-16 w-16 rounded-full bg-muted flex items-center justify-center mb-4">
										<HeaderIcon className="h-8 w-8 text-muted-foreground" />
									</div>
									<h3 className="text-lg font-semibold mb-1">No Report Generated</h3>
									<p className="text-sm text-muted-foreground max-w-md">
										Select an Institution and Examination Session, then pick a report type to generate automatically.
									</p>
								</div>
							</CardContent>
						</Card>
