-- =====================================================
-- SEED PAGE PERMISSION FOR THE EXAM APPLICATIONS PAGE
-- Date: 2026-08-19
-- Purpose:
--   Register `page.exam_management.exam_applications.view` so the new
--   Exam Application page appears in the sidebar for the same roles that
--   can already reach Exam Registrations.
--
...
WITH page_perms(name, description, resource, role_names) AS (
	VALUES
		(
			...
			'Access Exam Applications page',
			'page.exam_management.exam_applications',
