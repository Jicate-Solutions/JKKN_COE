export function mapCourseMappingToResponse(dbMapping: any, format: 'mapped' | 'raw' = 'mapped') {
  ...
  const base = {
    ...
    batch_code: dbMapping.batch_code ?? null,
    batch_id: dbMapping.batch_id ?? null,
    course_order: dbMapping.course_order,
    group_order: dbMapping.group_order,
    course_group: dbMapping.course_group ?? null,
    course_category: dbMapping.course_category ?? null,
    annual_semester: dbMapping.annual_semester ?? null,
    registration_based: dbMapping.registration_based ?? null,
