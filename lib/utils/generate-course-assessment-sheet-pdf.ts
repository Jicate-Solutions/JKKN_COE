...
function drawHeader(doc: jsPDF, data: CourseSheetData, program: CourseSheetProgram): void {
	...
	// Exam session line, e.g. END SEMESTER EXAMINATION - NOV-DEC-2026
	doc.setFont('times', 'bold')
...
// ========================================================================
// ATTENDANCE SHEET - blank date columns, table ends at the last learner
// ========================================================================
